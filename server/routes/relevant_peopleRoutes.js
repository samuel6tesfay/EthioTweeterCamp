...
relevant_peopleRoutes.post('/relevant_people',verifyToken,relevant_peoples.createrelevant_people);
relevant_peopleRoutes.get('/relevant_people/:id',relevant_peoples.relevant_people);
relevant_peopleRoutes.put('/relevant_people/:id',verifyToken,relevant_peoples.updaterelevant_people);
relevant_peopleRoutes.delete('/relevant_people/:id',verifyToken,relevant_peoples.deleterelevant_people);
